...
def main():
    ...
    parser.add_argument('--set', choices=['development', 'confirmation', 'exposed_repetition', 'exposed_framing', 'exposed_local', 'exposed_context', 'exposed_instruction', 'exposed_construction', 'exposed_purpose', 'exposed_verb', 'exposed_relations', 'exposed_projection', 'exposed_scope', 'exposed_proposition', 'exposed_clauses', 'exposed_action', 'exposed_roles', 'exposed_boundaries'], required=True)
