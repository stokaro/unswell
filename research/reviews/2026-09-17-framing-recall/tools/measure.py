...
def main():
    ...
    parser.add_argument('--set', choices=['development', 'confirmation'], required=True)
    ...
    archive = (DEVELOPMENT if args.set == 'development' else ROOT/'confirmation') / 'inputs.tar.gz'
