...
SEED = 'verb-scaffolding-confirmation-v1'
...
def main():
    ...
    previous = [original] + [review/('2026-09-17-'+name)/'confirmation/manifest.json'
                            for name in ('framing-recall', 'repetition-scope', 'local-repetition', 'context-recall', 'instruction-recall', 'construction-recall', 'purpose-recall')]
