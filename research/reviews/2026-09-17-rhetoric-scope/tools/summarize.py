#!/usr/bin/env python3
"""Validate rhetoric-scope inputs, judgments and full-page measurements."""
import argparse
...
PARENT = ROOT.parent/'2026-09-17-instruction-projection'
spec = importlib.util.spec_from_file_location('instruction_projection_evidence', PARENT/'tools/summarize.py')
...
def data_sets():
    ...
    sets['exposed_projection'] = sets.pop('confirmation')
...
def inherited_claims(split, profile):
    old_split = 'confirmation' if split == 'exposed_projection' else split
