#!/usr/bin/env python3
"""Validate instruction-projection inputs, judgments and full-page measurements."""
import argparse
...
PARENT = ROOT.parent/'2026-09-17-rhetoric-relations'
spec = importlib.util.spec_from_file_location('rhetoric_relations_evidence', PARENT/'tools/summarize.py')
...
def data_sets():
    ...
    sets['exposed_relations'] = sets.pop('confirmation')
...
def inherited_claims(split, profile):
    old_split = 'confirmation' if split == 'exposed_relations' else split
