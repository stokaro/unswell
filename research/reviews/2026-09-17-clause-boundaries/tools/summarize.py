#!/usr/bin/env python3
"""Validate clause-boundary inputs, judgments and full-page measurements."""
import argparse
...
PARENT = ROOT.parent/'2026-09-17-discourse-roles'
spec = importlib.util.spec_from_file_location('discourse_roles_evidence', PARENT/'tools/summarize.py')
...
def data_sets():
    ...
    sets['exposed_roles'] = sets.pop('confirmation')
...
def inherited_claims(split, profile):
    old_split = 'confirmation' if split == 'exposed_roles' else split
