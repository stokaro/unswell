...
def main():
    ...
    parser.add_argument('--set', choices=['development', 'confirmation', 'exposed_repetition', 'exposed_framing', 'exposed_local', 'exposed_context', 'exposed_instruction'], required=True)
