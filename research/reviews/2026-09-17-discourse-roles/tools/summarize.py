#!/usr/bin/env python3
"""Validate discourse-role inputs, judgments and full-page measurements."""
import argparse
...
PARENT = ROOT.parent/'2026-09-17-action-grammar'
spec = importlib.util.spec_from_file_location('action_grammar_evidence', PARENT/'tools/summarize.py')
...
def data_sets():
    ...
    sets['exposed_action'] = sets.pop('confirmation')
...
def inherited_claims(split, profile):
    old_split = 'confirmation' if split == 'exposed_action' else split
