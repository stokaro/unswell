...
def main():
    ...
    parser.add_argument('--set', choices=['development', 'confirmation', 'exposed_repetition', 'exposed_framing', 'exposed_local', 'exposed_context', 'exposed_instruction', 'exposed_construction', 'exposed_purpose', 'exposed_verb', 'exposed_relations', 'exposed_projection', 'exposed_scope'], required=True)
    ...
    sets = {'exposed_scope': ROOT.parent/'2026-09-17-rhetoric-scope/confirmation', 'exposed_projection': ROOT.parent/'2026-09-17-instruction-projection/confirmation', 'development': DEVELOPMENT, 'confirmation': ROOT/'confirmation',
