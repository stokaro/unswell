#!/usr/bin/env python3
"""Validate rhetorical-relation inputs, judgments and full-page measurements."""
import argparse
...
PARENT = ROOT.parent/'2026-09-17-verb-scaffolding'
spec = importlib.util.spec_from_file_location('verb_scaffolding_evidence', PARENT/'tools/summarize.py')
...
def data_sets():
    ...
    sets['exposed_verb'] = sets.pop('confirmation')
...
def inherited_claims(split, profile):
    old_split = 'confirmation' if split == 'exposed_verb' else split
