...
func TestRepetitionGroupActivationsDistinguishMissingFromZero(t *testing.T) {
	...
	for _, test := range []struct{ id, text, parameters, reason string }{
		...
		{"repetition.paragraph-openers", "Hi. " + prose, "", "no_eligible_tokens"},
		{"repetition.paragraph-openers", "The client waits. The server starts. The client reads. The server stops.", "", ""},
		{"repetition.paragraph-openers", "The client waits. The server stops.", "", "insufficient_words"},
		{"repetition.paragraph-openers", "The client waits. The server eventually stops.", "{min_words: 7}", ""},
		{"repetition.paragraph-openers", "The client waits. The server eventually stops.", "{min_words: 8}", "insufficient_words"},
		{"repetition.paragraph-openers", "The client waits. `one two three four five six seven eight nine ten`.",
			"", "insufficient_words"},
