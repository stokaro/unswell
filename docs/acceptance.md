...
| C. Comparable experiment | In progress | Amendment 1 of the protocol runs generation through session agents with no paid call. The [pilot record](../research/generation/runs/2026-09-11-pilot/README.md) and the [second run](../research/generation/runs/2026-09-11-run2/README.md) hold 800 saved responses of one model on 200 tasks; the [third run](../research/generation/runs/2026-09-12-haiku/README.md) holds 800 responses of a second model of the same family on the same tasks. Each run keeps its controlled shards and paired tables. A second family and protocol version 2 remain open |
