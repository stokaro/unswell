...
| Reproducible performance and resource limits | Partly met | [scan cost](performance.md): the synthetic corpus and the pytest tree meet the target on the 2-vCPU host; the FastAPI tree needs 13 s and the date-fns tree exceeds 512 MiB, tracked in [#181](https://github.com/stokaro/unswell/issues/181) |
