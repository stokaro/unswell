...
| Review on real texts | Partly met | The dated reviews cover [Ptah](../research/reviews/2026-09-15-contextual/README.md), [complete technical documents and generated responses](../research/generation/studies/long-prose-v3/inspection.md), and [this repository](../research/reviews/2026-09-11-unswell/README.md). The [offline fixtures](../e2e/testdata/long_prose_research/README.md) preserve concrete edits and technical counterexamples. The [whole-page audit](../research/reviews/2026-09-17-full-page-recall/README.md) adds missed-event recall and complete finding dispositions. The maintainer accepted its assistant judgments under ADR 0041. The [construction follow-up](../research/reviews/2026-09-17-construction-recall/README.md) raises exposed instruction-page detections from 12/99 to 27/99, but six new pages move only from 0/32 to 1/32 (Ptah 1/18). The [clause-grammar follow-up](../research/reviews/2026-09-18-clause-grammar/README.md) restores two lost diagnoses and raises the exposed boundary sample from 2/56 to 7/56, while six new sources remain at 2/34. The [discourse experiment](../research/reviews/2026-09-18-discourse-patterns/README.md) rejects its candidate after twelve new pages remain at 2/106 (Ptah 0/31); the runtime is unchanged. Broad recall, review burden, #305 and unsupported constructions remain open |
